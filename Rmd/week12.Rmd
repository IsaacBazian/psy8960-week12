...
url = "https://old.reddit.com/r/IOPsychology/new/"
hold_tbl <- tibble(title_loop = NA, upvotes_loop = NA)


for (i in seq(25, 800, 25)){
...
test_tbl <- bind_rows(hold_tbl, loop_tbl)
...
url <- paste0("https://old.reddit.com/r/IOPsychology/new/?count=", 25, "&after=t3_", last_post_id)
