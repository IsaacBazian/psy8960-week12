...
```{r data_import_2}
riopsychology_html <- read_html("https://old.reddit.com/r/IOPsychology/new/?count=1")

html_elements(riopsychology_html, xpath = "//p") %>%
  html_attr("href")
...
#url <- paste0("https://old.reddit.com/r/IOPsychology/new/?count=", i, "&after=t3_")
...
io_slim_dtm <- removeSparseTerms(io_dtm, .98)
