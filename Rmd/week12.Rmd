...
# The following preprocessing makes these specific entries contain nothing. Less agressize preprocessing was not reasonable,
# as they are just full of standard english stopwords and some variation of 'IO Psychology', which we also want to remove.
# Simply making them say "empty" (a token that does not otherwise occur in this corpus) ensures that they don't cause problems.
# I know this technically makes up data, but this is an extremely small portion of the corpus/data, so I figures this
# workaround is 'good enough' from a data science perspective.
week12_tbl_pre_preprocess$title[487] <- "empty"
week12_tbl_pre_preprocess$title[570] <- "empty"
week12_tbl_pre_preprocess$title[737] <- "empty"
...
```{r lda_results}
lda_results <- LDA(io_dtm, 3) # 3 seems the most comprehensible of 3, 4, 5
