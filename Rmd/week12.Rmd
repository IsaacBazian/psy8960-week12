...
We set up parallelization to find the number of appropriate topics for our data with LDA. Examining the LDA graphs makes it seem like 5 may be the best number of topics, as that's where the 'Maximize' metrics clearly cross over, but to be sure I also examined 3, 4, and 6 because the 'CaoJuan2009' Minimize metric seems a bit lower there, and I figured I may as well see if more or less topics made more sense based on observations of the different Beta matrices.
```{r lda_tuning}
